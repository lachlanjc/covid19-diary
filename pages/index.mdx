import { Box, Card, Grid, Heading, Link, Image, BaseStyles, Container } from 'theme-ui'
...
<Box as="header" sx={{
  ...
  <Container sx={{ textShadow: 'text', color: 'white' }}>
    ...
    <Text variant="subtitle" sx={{ mt: 2, fontSize: [3,4] }}>By <Link color="lilac" href="https://lachlanjc.com">@lachlanjc</Link></Text>
  </Container>
</Box>
...
<Box as="iframe" variant="styles.site" src="https://predictcovid.netlify.app" />
...
<Box as="iframe" variant="styles.site" src="https://covidtesting.vercel.app" />
...
<Stat value={41} unit="" label="listens so far" />
</Card>
...
<Song url="https://song.link/us/i/1396292371" />
