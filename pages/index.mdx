...
The flip side: we don’t need to be guilty if we’re happy right now. It’s valid. If we were all only greiving for a year, we’d have nothing else left to do.
...
But **if we let go of beauty, we don’t have anywhere to go back to**. We can’t let go of beauty. We can’t slip, lose control of our grasp, our attention to our consciousness & our reality. We must keep producing, creating, recording, synthesizing, sharing. If we solved the pandemic but came back to a wasteland, would we be better off?
