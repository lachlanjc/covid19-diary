...
<Box as="iframe" variant="styles.embed" src="https://predictcovid.com" />
...
<Card variant="sunken" sx={{ py: [3, 3], my: [3, 4] }}>
...
<Box as="iframe" variant="styles.embed" src="https://testing.predictcovid.com" />
